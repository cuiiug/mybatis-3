...
/**
 * 1、 从mybatis-config.xml中读取配置；2、从mapper配置文件或Mapper注解读取的配置
 * 
 */
public class Configuration {
	...
	// 当开启时，任何方法调用 都会加载该对象的所有属性，否则按需加载， false（ture in >3.4.1）
	...
	// 延迟加载的全部开关，当开启时，所有关联对象都会延迟加载。特定关联关系中，可以通过设置fetchType属性来覆盖该项开关状态
	protected boolean lazyLoadingEnabled = false;
	// 指定 Mybatis 创建具有延迟加载能力的对象所用到的代理工具。;默认JAVASSIST (MyBatis 3.3 or above) ,可选CGLIB
	// | JAVASSIST
